...
/**
 * Compressor. Compressor handles the press that pushes the balls down one level
 * at a time. CompressorHead is the big horizontal sprite, drawn once.
 * Compressor is the small vertical sprite that makes up the left and right
 * columns. It is drawn two times per level for each column.
 * 
 */
public class Compressor {
	 ...
	 * 
	 * @param compressorHead
	 *            BmpWrap - Big horizontal plate
	 * @param compressor
	 *            BmpWrap - small vertical column section sprite
	 */
	...
	/**
	 * moveDown. Moves balls down one level.
	 */
	...
	/**
	 * paint. Paint the Compressor sprites.
	 * 
	 * @param c
	 *            Canvas
	 * @param scale
