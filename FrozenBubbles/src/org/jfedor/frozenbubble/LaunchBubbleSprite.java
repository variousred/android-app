...
/**
 * Class LaunchBubbleSprite. Launches the next bubble.
 * 
 */
public class LaunchBubbleSprite extends Sprite {
	...
	/**
	 * LaunchBubbleSprite. Initialization.
	 * 
	 * @param initialColor
	 *            int
	...
	/**
	 * paint. Paints the bubble we are launching and the scaled and rotated
	 * launcher.
	 * 
	 * @param c
	 *            Canvas
